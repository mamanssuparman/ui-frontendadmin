...
$.extend( true, DataTable.defaults, {
	dom:
		"<'grid grid-cols-1 md:grid-cols-2'" +
			...
			"<'my-2 col-span-2 rounded min-w-full bg-white dark:bg-gray-800 'tr>" +
			"<'self-center'i>" +
...
$.extend( DataTable.ext.classes, {
	...
	sFilterInput:  "border h-8 placeholder-gray-500 ml-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500 dark:placeholder-gray-400",
	sLengthSelect: "border h-8 px-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500",
	sProcessing:   "dt-processing uk-panel",
	tailwindcss: {
		paging: {
			active: 'h-8 font-semibold bg-gray-100 dark:bg-gray-700/75',
			notActive: 'h-8 bg-white dark:bg-gray-800',
			button: 'h-8 relative inline-flex justify-center items-center space-x-2 border px-4 py-2 -mr-px leading-6 hover:z-10 focus:z-10 active:z-10 border-gray-200 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:active:border-gray-700',
			first: 'h-8 rounded-l-lg',
			last: 'h-8 rounded-r-lg',
		...
		thead: {
			row: 'text-black',
			cell: 'px-3 py-4 bg-gray-400 font-semibold text-left'
		},
		tbody: {
